...
- Me enfoco en el desarrollo full-stack: backends sólidos con Laravel/PHP y frontends con React / Inertia.js.
- Trabajo con PostgreSQL, MySQL y MongoDB, APIs REST, Docker y Git/GitHub. Nivel básico de Azure.
- Me gusta construir aplicaciones completas, desde la base de datos hasta la interfaz, y trabajar en equipo con Git.
...
[![Tecnologías](https://skillicons.dev/icons?i=html,css,js,ts,react,nextjs,nodejs,php,laravel,python,kotlin,docker,postgres,mysql,mongodb,azure,git&perline=9)](https://skillicons.dev)
